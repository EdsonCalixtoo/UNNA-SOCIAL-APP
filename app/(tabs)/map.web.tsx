...
// Maps are not available on web in this implementation.
// The render logic already handles Platform.OS === 'web' by showing a list view.
...
// Marcador Premium com Círculo de Ferro (Proteção contra corte no Android)
const EventMarker = ({ event, markerColor, onPress }: { event: any; markerColor: string; onPress: () => void }) => {
  ...
  return (
    ...
    >
      {/* 
          ...
          Sendo um quadrado perfeito sem borderRadius, o Android não corta.
      */}
      <View style={{
        width: 48,
        height: 48,
        ...
        <View style={{
          ...
          justifyContent: 'center',
          alignItems: 'center',
          opacity: 0.99, // Hack de renderização
        }}>
          {isImageUrl ? (
            <Image 
              source={{ uri: icon }} 
        ...
        {selectedEvent && selectedEvent?.id && (
          <TouchableOpacity 
            style={[
              ...
              { bottom: insets.bottom + 110 } // OFFSET FOR FLOATING NAVBAR
            ]}
            activeOpacity={0.95}
            onPress={() => {
...
const styles = StyleSheet.create({
  ...
  markerPointer: {
    ...
    marginTop: -2, // Sobreposição leve para não vazar luz
  },
  markerShadow: {
    width: 8,
    height: 4,
